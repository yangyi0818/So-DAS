...
from model import make_model_and_optimizer, com_sisdr_loss1, com_sisdr_loss2

parser = argparse.ArgumentParser()
parser.add_argument("--use_aneconic", type=int, required=True, help="")
parser.add_argument("--channel_permute", type=int, required=True, help="")
...
def main(conf):
    ...
    trainer = pl.Trainer(
        ...
        #resume_from_checkpoint='exp/_ckpt_epoch_19.ckpt',
