...
if __name__ == "__main__":
    separated_base, ref_base = sys.argv[1], sys.argv[2]
    ...
    for subset in ['0degree-20degree', '21degree-45degree', '46degree-90degree', '91degree-180degree']:
        ...
        separated = os.path.join(separated_base, subset)
        ref = os.path.join(ref_base, subset)
        ...
        for i in pbar:
            ...
            #pbar.set_description("pesq: {:.3f}, stoi: {:.3f}, sdri: {:.3f}".format(pesq_score/(i+1), stoi_score/(i+1-num_warning), sdri_score/2/(i+1)))
